...
<ul class="list-filter">
  <li><a href="admin/plugins?f=active">Active</a></li>
  <li><a href="admin/plugins?f=disabled">Disabled</a></li>
  <li><a href="admin/plugins?f=all">All</a></li>
</ul>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="admin/plugins/options?id=<?php echo $plugin->id(); ?>">Options</a>
        <?php if ($plugin->id() > 1): ?>
         -
